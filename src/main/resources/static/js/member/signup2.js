$(function(){
    ...
    let comName = signTable.find("input[name='comName']");
    ...
    // 
    let brn = signTable.find("input[name='brn']");
    let repName = signTable.find("input[name='repName']");
    let staffName = signTable.find("input[name='staffName']");
    let sellingUrl = signTable.find("input[name='sellingUrl']");
    // 
    ...
    signupBtn.click((e)=>{
        ...
        fetch('signup2',{
            ...
            body: JSON.stringify({
                ...
                telephone: mobile1.val() + "-" + mobile2.val() + "-" + mobile3.val(),
                phone: phone1.val() + "-" + phone2.val() + "-" + phone3.val(),
                brn: brn.val(),
                repName: repName.val(),
                staffName: staffName.val(),
                sellingUrl: sellingUrl.val()
            })
        })
        .then(()=>{
        	alert("회원가입이 완료되었습니다!")
