            ...
            <table class="signup-table">
                <tr>
                    ...
                    <td> 
                        <ul class="division-list">
                            <li><input type="radio" checked>판매자</li>
                        </ul>
                    </td>
                </tr>
            </table>
                ...
                <section class="member-default-info">
                    ...
                    <table class="signup-table">
                            ...
                            <tr>
                                <td><span class="font-color-red">*</span>상호명</td>
                                <td><input type="text" name="comName"></td>
                            </tr>
                            <tr>
                                <td><span class="font-color-red">*</span>사업자등록번호</td>
                                <td><input type="text" name="brn"></td>
                            </tr>
                            <tr>
                                <td><span class="font-color-red">*</span>대표명</td>
                                <td><input type="text" name="repName"></td>
                            </tr>
                            <tr>
                                <td><span class="font-color-red">*</span>담당자명</td>
                            ...
                            <tr>
                                <td>판매사이트 url</td>
                                <td><input type="text" name="sellingUrl"></td>
                            </tr>
                    </table>
                </section>
